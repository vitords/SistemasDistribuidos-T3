 ...
 * @author Vitor
 */
public class Peer extends UnicastRemoteObject implements IQuadroAviso {
    ...
    private ArrayList<IQuadroAviso> quadros;
    ...
    public void setAviso(String aviso) throws RemoteException {
        Iterator<IQuadroAviso> it = quadros.iterator();
        while (it.hasNext()) {
            IQuadroAviso quadro = it.next();
            try {
    ...
    public static void main(String[] args) throws RemoteException {
        Peer quadro = new Peer();
        janela = new QuadroGUI((Peer) quadro);
